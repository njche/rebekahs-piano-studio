        ...
        <div className="Compositions">
            <div className="Compositions-wrapper">
                ...
                <div className="Compositions-image">
                    <img src="hshot6blackedit.webp" className="Compositions-image" id="compositions-image"></img>
                    <div className="Composition-bio">
                        ...
                        <iframe className="Composition-video-2" width="56.5%" height="20%" src="https://www.youtube.com/embed/rNJD26qj3zg?rel=0&amp;showinfo=0&amp;rel=0" title="Sonata no.1 - Rebekah Shomsky" frameBorder="0" allow="fullscreen"></iframe>
                    </div>
                </div>
            </div>
        </div>
