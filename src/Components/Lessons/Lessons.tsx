                    ...
                    </h1>
                    {
                        ...
                        <div className="Lessons-slide-wrapper">
                            <div className='Lessons-slide-grid'> 
                                <img className='Lessons-slide-pictures' src='Tech-lite.webp' loading="lazy" width="100%" height="auto" alt="Slide" />
                                <div className={'Lessons-slide-text-0'}>
                                    {texts[0]}
                                </div>
                                <img className='Lessons-slide-pictures' src='Sheet-lite.webp' loading="lazy" width="100%" height="auto" alt="Slide" />
                                <div className={'Lessons-slide-text-1'}>
                                    {texts[1]}
                                </div>
                                <img className='Lessons-slide-pictures' src='Musicality-lite.webp' loading="lazy" width="100%" height="auto" alt="Slide" />
